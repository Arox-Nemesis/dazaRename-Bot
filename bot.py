...
class Bot(Client):
    ...
    async def start(self):
        ...
        print(f"Ê€á´€á´˜á´ https://github.com/AshutoshGoswami24/Rename-Bot")
        print(f"Ê€á´€á´˜á´ á´„Ê€á´‡á´€á´›á´Ê€ https://github.com/AshutoshGoswami24")
        ...
        if Config.LOG_CHANNEL:
            try:
                ...
                await self.send_message(Config.LOG_CHANNEL, f"**{me.mention} Is Restarted !!**\n\nðŸ“… Date : `{date}`\nâ° Time : `{time}`\nðŸŒ Timezone : `Asia/Kolkata`\n\nðŸ‰ Version : `v{__version__} (Layer {layer})`</b>")                                
            except:
